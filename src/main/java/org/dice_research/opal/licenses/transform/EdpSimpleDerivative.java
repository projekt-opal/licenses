 ...
 * @author Adrian Wilke
 */
public class EdpSimpleDerivative {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		EdpSimpleDerivative instance = new EdpSimpleDerivative();

		// Get source data
		File file = File.createTempFile(EdpSimpleDerivative.class.getSimpleName(), ".csv");
		file.deleteOnExit();
