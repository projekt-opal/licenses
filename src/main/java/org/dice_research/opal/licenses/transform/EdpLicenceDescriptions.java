 ...
 * @author Adrian Wilke
 */
public class EdpLicenceDescriptions {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		EdpLicenceDescriptions instance = new EdpLicenceDescriptions();

		// Get source data
		File file = File.createTempFile(EdpLicenceDescriptions.class.getSimpleName(), ".csv");
		file.deleteOnExit();
